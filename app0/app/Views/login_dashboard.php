...
<html lang="en">
    <head>
        ...
        <title>Login Dashboard Plant Engineer</title>
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header">
                                        <img src="<?= base_url() ?>/assets/img/Logo_PE_MIP-removedbg.png"  style="display: block; margin-left: auto;margin-right: auto;" width="200" alt=""/> 
                                        <h3 class="text-center font-weight-light my-4">Login Dashboard Plant Engineer</h3>
                                    </div>
                                    <div class="card-body">
                                        <form method="post" action="<?= base_url('dashboard/loginproses') ?>">
