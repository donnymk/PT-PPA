            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <br><br>
                        <table class="table table-bordered" id="dataPopulasi">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Model Unit</th>
                            ...
                            <tbody>
                                ...
                                foreach ($populasi as $key => $value):
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-secondary btn-sm" href="delete_populasi/<?= $no ?>" onclick="return confirm_del(<?= $no ?>)"><span class="fa fa-trash"></span></a></td>
                                    </tr>
                                    <?php
                                endforeach
                                ?>
